<template>
  <div>
    ...
    <li v-if="currentUser && $route.params.cohort_id == 149"><router-link :to="{ name: 'standards-skill-tree', params: { cohort_id: $route.params.cohort_id} }"><i class="material-icons left">nature</i>Skill Tree</router-link></li>
